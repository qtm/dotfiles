...
requests_cache.install_cache('toggl_cache', backend='sqlite', expire_after=300)
...
class TogglAPI(object):
    ...
    def get_minutes_tracked(self, start_date, end_date):
        ...
        return (total_seconds_tracked / 60.0)
